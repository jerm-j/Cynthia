...
OscillatorComponent::OscillatorComponent(APVTS &apvts) : morphValueKnobAttachment(apvts, ParameterID::morphValue.getParamID(), morphValueKnob),
                                                         detuneDentsKnobAttachment(apvts, ParameterID::detuneCents.getParamID(), detuneCentsKnob),
                                                         wavetypeAComboBoxAttachment(apvts, ParameterID::wavetypeA.getParamID(), wavetypeAComboBox),
                                                         wavetypeBComboBoxAttachment(apvts, ParameterID::wavetypeB.getParamID(), wavetypeBComboBox)
